      ...
      <!-- Default Tabs -->
                       ...
                       <div div class="row">
                        <div class="col-md-3"> <lable>Name</lable> <input type="text" id="filterOne" class="form-control input-sm"> </div>
                         <div class="col-md-3" style="z-index: 999;"><lable> Category Name</lable>
                           <select class="form-control input-sm" name="category_id" id="filterTwo">
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>media/add_sub_categories/add" method="POST" class="row crudForm g-3">
                       ...
                       <div class="col-md-4">
                           ...
                           <div class="col-md-4">
                                <label for="" class="form-label">Banner (Series 263*393,Topic 174*260)</label>

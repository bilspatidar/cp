      ...
      <!-- Default Tabs -->
              ...
              <div class="tab-content pt-2" id="myTabContent">
                 <div class="tab-pane fade show active session_views" id="home" role="tabpanel" aria-labelledby="home-tab">
                   <form class="form-inline filterForm">
                       ...
                       <div class="col-md-3" style="z-index: 999;"> <lable>Status</lable> <select id="filterThree" class="form-control input-sm"><option value="">Status</option><option value="Active">Active</option><option value="Deactive">Deactive</option></select> </div>
                       <div class="col-md-3" style="z-index: 999;"> <lable>Show Deleted</lable> <select id="filterFour" class="form-control input-sm"><option value="0">No</option><option value="1">Yes</option></select> </div>  
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>media/add_live_streaming/add" method="POST" class="row crudForm g-3">
                            
                           
								
						      <div class="col-md-12">
                                <label for="" class="form-label">URL</label>
                                <textarea type="text" name="rtmp1" class="form-control"></textarea>
                          </div>
                        ...
                        <option value="Deactive">Deactive</option></select>
                          ...
                          <div class="col-md-12">
                                ...
                                <textarea type="text" name="rtmp2" class="form-control"></textarea>
                          </div>

<!---
                         
                          <div class="col-md-12">
                                <label for="" class="form-label">RTMP3</label>
                                <textarea type="text" name="rtmp3" class="form-control"> </textarea>
                          </div> -->
                          <div class="col-12">

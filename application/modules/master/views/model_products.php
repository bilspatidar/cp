...
<!-- Button trigger modal -->
 <div class="tab-content pt-2" id="myTabContent">
   ...
   <a href='<?php echo base_url();?>master/products' >
     ...</a>
...
<!-- Modal -->
 ...
 <!--<form id="crudForm" action="<?php echo base_url(); ?>master/add_model_product/update" method="POST" class="row g-3">-->
    
         <!--echo $allProduct = $this->Mdlmaster->get_model_products();-->
...
function loadTableData_model(page){
	...
	var url = "<?php base_url(); ?>master/get_model_products/"+page;
	var postData = '';
    //filter

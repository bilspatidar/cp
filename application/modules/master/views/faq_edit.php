 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_faq/update" method="POST" class="row g-3">
                          <div class="col-md-12">
                <label for="" class="form-label">Question</label>
                <input type="hidden" name="id" class="form-control" value="<?php echo $row[0]->id; ?>"> 
                <input type="text" name="question" class="form-control" value="<?php echo $row[0]->question; ?>"> 
          </div>
                       
                      
               <div class="col-md-12">
                                <label for="" class="form-label">Answer</label>
			<textarea class="form-control" name="answer"><?php echo$row[0]->answer;?></textarea>
			</div>
            <div class="col-md-4">

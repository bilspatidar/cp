 ...
 <div class="card">
      ...
      <!-- Default Tabs -->
		...
		<form id="crudForm" action="<?php echo base_url(); ?>master/add_new_product_variation/add" method="POST" class="row crudForm g-3">
				...
				<select name="attribute_id" class="form-control">
                         ...
                         <?php 
						 $getAttributes = $this->Common->getAttribute();

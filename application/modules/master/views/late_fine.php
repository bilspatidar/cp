      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_late_fine/add" method="POST" class="row crudForm g-3">
                          <div class="col-md-4">
                                <label for="" class="form-label">From Day</label>
                                <input type="text" name="fromDay" class="form-control"> 
                          </div>
                          
                          <div class="col-md-4">
                                <label for="" class="form-label">To Day</label>
                                <input type="text" name="toDay" class="form-control"> 
                          </div>
                          
                          <div class="col-md-4">
                                <label for="" class="form-label">Fine Inr</label>
                                <input type="text" name="fine_inr" class="form-control"> 
                          </div>
                          
                          <div class="col-md-4">
                                <label for="" class="form-label">Fine Percentage</label>
                                <input type="text" name="fine_percentage" class="form-control"> 
                          </div>

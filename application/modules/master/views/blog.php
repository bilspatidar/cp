...
<form id="crudForm" action="<?php echo base_url(); ?>master/add_blog/add" method="POST" class="row crudForm g-3">
                          ...
                          <div class="col-md-12">
                                <label for="" class="form-label">Blog Keyword(keyword one,keyword two,..........keyword n)</label>

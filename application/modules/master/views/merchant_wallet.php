      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_merchant_wallet/add" method="POST" class="row crudForm g-3">
                        ...
                        <select class="form-control" name="merchant_id">
                         <option value="">Select Merchant</option>
                            ...
                            ?>
                            <option value="<?php echo $merchantrow->users_id; ?>" required><?php echo $mname; ?>-<?php echo $merchantMobile;?>-<?php echo '(Spot '.$amount.')' ;?> </option>
                            <?php } ?>
                         </select>
                         </div>

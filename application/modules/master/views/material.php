      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_material/add" method="POST" class="row crudForm g-3" enctype="multipart/form-data">
                          ...
                          <div class="col-md-6">
                                ...
                                <input type="text" name="material_keyword" class="form-control"> 
                           </div>

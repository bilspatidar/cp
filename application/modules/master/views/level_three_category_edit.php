                 ...
                 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_level_three_category/update" method="POST" class="row g-3">
            ...
            <div class="col-md-4">
               ...
               <select class="form-control select2" name="category_id" style="width:100%" required onChange="getSubCategoryModal(this.value)" >                                                       
                   ...
                   <div class="col-md-4">
                    ...
                    <select class="form-control" name="sub_category_id" id="subcategory_html_modal" style="width:100%" required>
                    <?php 
                            $categories = $this->Common->getSubcategory();
                            foreach($categories as $category){ ?>
                            <option value="<?php echo $category->id; ?>"<?php if($category->id==$row[0]->sub_category_id) {echo 'selected';} ?>>  
                                <?php echo $category->name; ?></option>
                            <?php } ?>
                          ...
                          <div class="col-md-4">
                    		...
                    		if(!empty($File))
                    		{ 
                    	        $load_url = 'uploads/level_three_category/'.$File;

...
<form id="crudForm" action="<?php echo base_url(); ?>master/add_course_session/add" method="POST" class="row crudForm g-3">
                           ...
                           <div class="col-md-4">
                                ...
                                <input type="text" name="course_session" step="any" class="form-control"> 
                          </div>
                          <div class="col-md-4">
                                <label for="" class="form-label">Session Duration (In Min.)</label>
                                <input type="number" name="session_duration" step="any" class="form-control"> 
                          </div>

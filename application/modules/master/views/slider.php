		...
		<div class="tab-content pt-2" id="myTabContent">
			<div class="tab-pane fade show active session_views" id="home" role="tabpanel" aria-labelledby="home-tab">
				<form class="form-inline filterForm">
					<div div class="row">
						<div class="col-md-3"> <lable>Title</lable> <input type="text" id="filterOne" class="form-control input-sm"> </div>
			...
			<div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
				<form id="crudForm" action="<?php echo base_url(); ?>master/add_slider/add" method="POST" class="row crudForm g-3" enctype="multipart/form-data">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<label for="" class="form-label">Image <span style="font-size:12px">(Image should be upload only transparent.)</span></label>

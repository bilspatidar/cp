      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_sub_payment_type/add" method="POST" class="row crudForm g-3">
                     ...
                     <input type="hidden" name="payment_type_id" class="form-control" value="<?php echo $payment_type_id; ?>">

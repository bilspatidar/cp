                 ...
                 <div class="tab-pane fade show active session_views" id="home" role="tabpanel" aria-labelledby="home-tab">
                   <form class="form-inline filterForm">
                       <div div class="row">
                        ...
                        <div class="col-md-3"> <lable>Mobile</lable> <input type="text" id="filterTwo" class="form-control input-sm"> </div>                       
                       <div class="col-md-3"> <lable>Email</lable> <input type="text" id="filterThree" class="form-control input-sm"> </div>

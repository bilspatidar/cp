      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_payment_gateway/add" method="POST" class="row crudForm g-3">
                          ...
                          <div class="col-md-6">
                                ...
                                <input type="text" name="live_api" class="form-control"> 
                          </div>
                          
                          <div class="col-md-6">
                                <label for="" class="form-label">Live Secret</label>
                                <input type="text" name="live_secret" class="form-control"> 
                          </div>
                          
                          <div class="col-md-6">
                                <label for="" class="form-label">Test Api</label>
                                <input type="text" name="test_api" class="form-control"> 
                          </div>
                          
                          <div class="col-md-6">
                                <label for="" class="form-label">Test Secret</label>
                                <input type="text" name="test_secret" class="form-control"> 
                          </div>
                           <div class="col-md-6">

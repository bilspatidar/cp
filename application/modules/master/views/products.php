<div class="card">
      ...
      <!-- Default Tabs -->
              <ul class="nav nav-tabs" id="myTab" role="tablist">
               ...
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="bulk-tab" data-bs-toggle="tab" data-bs-target="#bulk" type="button" role="tab" aria-controls="bulk" aria-selected="false">Bulk Products</button>
                </li>
        ...
        // $edit_url    =  base_url().'master/model_products/';
       $edit_url  = base_url().'master/edit_form/model_products/product/product_id/';
		   $getDeleteOption = getDeleteOption();
     echo  $edit_link = "<a href='javascript:void(0)' onclick='edit_me(this.id);'  id='edit'  name='$edit_url' class='session_edits'>
     ...</a>";
...
<!-- Modal -->
      ...
      <!--                          <label for="" class="form-label">Product Barcode (leave blank if you want auto generated) </label>-->
						...
						<div class="col-md-4 priceDiv">
						   ...
						   <br>
							<input type="number" min="1" step="any" class="form-control" name="quantity">
						</div>
                 ...
                 <select class="form-control select2" name="material_id[]" style="width:100%" multiple>
               <option value="">Select Material</option>
              <?php 
              $material = $this->Common->getMaterial();
              foreach($material as $getMaterial){ ?>
              <option value="<?php echo $getMaterial->id; ?>"><?php echo $getMaterial->title; ?></option>
              <?php } ?>
              </select>
              </div>
                           <div class="col-md-4">

      ...
      <!-- Default Tabs -->
                   ...
                   <form class="form-inline filterForm">
                       <div div class="row">
                        <div class="col-md-3"> <lable>Name</lable> <input type="text" id="filterOne" class="form-control input-sm"> </div>
                         <div class="col-md-3" style="z-index: 999;"><lable> Category Name</lable>
                           <select class="form-control input-sm" name="category_id" id="filterFour">
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_level_four_category/add" method="POST" class="row crudForm g-3">
                          
                          <div class="col-md-4">
                             <label for="" class="form-label">Level Four Category Icon</label><br>
						  <!-- Button tag -->
								<button class="btn btn-default" role="iconpicker"></button>
								<!-- Div tag -->
								<div role="iconpicker" name="icon_maker"></div>
								</div>
						  ...
						  <div class="col-md-4">
                                ...
                                <input type="hidden" name="bgColor" class="form-control"> 
                          </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <select class="form-control select2" name="category_id[]" style="width:100%" required multiple onChange="getSubCategory(this.value)" >
                                       <option value="">Select Category</option>
                                        <?php 
                                        $categories = $this->Common->getProductCategory();
                                        foreach($categories as $category){ ?>
                               ...
                               <div class="col-md-4">
                                ...
                                <select class="form-control select2" name="sub_category_id" id="subcategory_html" style="width:100%" required onChange="getLevelTreeCategory(this.value)">
                        ...
                        <div class="col-md-4">
                                ...
                                <select class="form-control select2" name="level_three_category_id" id="level_threeh_html" style="width:100%"  >
                                     </select>
                                     </div>
									 
								<!--	 <div class="col-md-4">
                                <label for="" class="form-label">Icon Maker</label>
                                <input type="text" name="icon_maker" class="form-control"> 
                          </div> -->
						  
                          <div class="col-md-4">
                                <label for="" class="form-label">Image(400*400)</label>
                                <input type="hidden" name="image">
                                <input type="file" name="image" class="form-control"> 
                          </div>
                          
                           <div class="col-md-4">
                                <label for="" class="form-label">Banner(1000*300)</label>

...
<form id="crudForm" action="<?php echo base_url(); ?>master/add_study_material/add" method="POST" class="row crudForm g-3" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                                ...
                                <input type="number" name="sr_number" class="form-control"> 
                          </div>
                        <div class="col-md-12">

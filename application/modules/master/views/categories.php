      ...
      <!-- Default Tabs -->
			...
			<div id="pageNumber" style="display:none;"></div>
                ...
                <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <form id="crudForm" action="<?php echo base_url(); ?>master/add_category/add" method="POST" class="row crudForm g-3" enctype="multipart/form-data">
                         
						 
						   <!-- <div class="col-md-4">
                                <label for="" class="form-label">Icon</label>
                                <input type="text" role="iconpicker" name="icon_maker" class="form-control icon_maker"> 
                          </div>
						 Example 1 -->

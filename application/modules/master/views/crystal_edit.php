 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_crystal/update" method="POST" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                                ...
                                <input type="text" name="crystal_keyword" class="form-control" value="<?php echo $row[0]->crystal_keyword ;?>"> 
                           </div>

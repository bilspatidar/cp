 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_business_role/update" method="POST" class="row g-3">
                          <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                                <label for="" class="form-label">Commision</label>
                                <input type="text" name="commision" class="form-control" value="<?php echo $row[0]->commision; ?>"> 
                          </div>  

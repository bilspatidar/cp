 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_level_two_category/update" method="POST" class="row g-3" enctype="multipart/form-data">
              ...
              <div class="col-md-4">
                    ...
                    <select class="form-control select2" name="category_id" style="width:100%" required onChange="getSubCategoryModal(this.value)" >                                                       
                           <option value="">Select Category</option>
                            ...
                            <?php if($category->product_category_id==$row[0]->category_id) {echo 'selected';} ?>>  

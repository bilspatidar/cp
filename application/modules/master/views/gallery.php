      ...
      <!-- Default Tabs -->
        ...
        <div class="tab-content pt-2" id="myTabContent">
                    ...
                    <form class="form-inline filterForm">
                        <div div class="row">
                        <div class="col-md-3"> <lable>Name</lable> 
                        <select class="form-control select2" id="filterOne" style="width:100%">
                            <option value="">Select Category </option>
                            <?php 
                            $categoriesF = $this->Common->getGalleryCategory();
                            foreach($categoriesF as $categoryf){ ?>
                            <option value="<?php echo $categoryf->id; ?>"><?php echo $categoryf->name; ?></option>
                            <?php } ?>
                        </select>
                        </div>
            ...
            <div class="tab-pane fade session_adds" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <form id="crudForm" action="<?php echo base_url(); ?>master/add_gallery/add" method="POST" class="row crudForm g-3">
                    ...
                    <div class="col-md-4">
                        <label for="" class="form-label">Image <span style="font-size:12px">(Image should be upload 626*418.)</span></label>

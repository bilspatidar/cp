 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>master/add_business_type/update" method="POST" class="row g-3">
                          <div class="col-md-4">
                                <label for="" class="form-label">Name</label>
                                <input type="hidden" name="business_id" class="form-control" value="<?php echo $row[0]->business_id; ?>"> 

...
<style>
.pagetitle{ 
background-image: url('https://consciousawakeningnetwork.org/streamingmedia/uploads/topic.png');
...
.paheheading h1{
 ...
 .dark{
    ...
    background: #fafafa;
    padding: 1px;
    box-shadow: 0px 2px 11px rgb(255 255 255 / 18%);
}
div#paginationLink {
    margin: auto;
    text-align: center;
...
<div class="pagetitleoverlay">
<div class="paheheading">
<h1>TOPICS</h1>
</div>
</div>
</section>

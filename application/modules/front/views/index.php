...
<script>
  ...
  on('.js-forward', 'click', () => { 
   ...
   <div class="home-slider position-relative mb-7">
	...
	<div class="container">
<!-- Modal -->
<div class="modal fade" id="myModal_<?php echo $Medias->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="<?php echo $Medias->video_link;?>" id="video"  allowscriptaccess="always" allow=""></iframe>
</div>
               ...
               <div class="slider-movie__hover d-flex flex-column z-index-2 px-4 pb-6 pb-lg-4 transition-1">
                  ...
                  <div class="mx-1">
                     ...
                     <div class="slider-movie__hover-watch-now d-flex justify-content-center d-xl-none mb-7">
						...
						<a type="button" class="btn btn-play d-flex align-items-center justify-content-center rounded-circle" data-toggle="modal" data-target="#myModal_<?php echo $Medias->id; ?>">
   <i class="fas fa-play text-primary "></i>
</a>

...
<video id="player" playsinline controls data-poster="/path/to/poster.jpg">
  <source src="<?php echo $nu; ?>" type="video/mp4" />
  <source src="<?php echo $nu; ?>" type="video/webm" />

  <!-- Captions are optional -->
  <track kind="captions" label="English captions" src="<?php echo $nu; ?>" srclang="en" default />
</video>
</div>

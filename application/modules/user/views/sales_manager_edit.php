 ...
 <form id="crudFormEdit" action="<?php echo base_url(); ?>user/add_sales_manager/update" method="POST" class="row g-3">
                         
                       
                       
                             	<div class="col-md-4">
                                <label for="" class="form-label"> State Name</label>
                                <select class="form-control select2" name="state_id" style="width:100%"onChange="getStateAdminModal(this.value)">
                          ...
                          <div class="col-md-6">
                              <label for="" class="form-label">State Admin Name</label>
                                <select class="form-control select2" name="parent_id" style="width:100%" id="states_admin_html_modal">
                                    
                                     <option value="<?php echo $row[0]->parent_id; ?>"><?php echo $this->Common->get_col_by_key('users','users_id',$row[0]->parent_id,'name'); ?></option>

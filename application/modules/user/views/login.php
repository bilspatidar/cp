          ...
          <div class="row justify-content-center ">
            ...
            <div class="d-flex justify-content-center py-2">
                ...
                <div class="card-body m-t-n-lg">
                  ...
                  <form id="AdminLoginForm" action="<?php echo base_url(); ?>user/auth_login"  method="POST" class="row g-3 m-t-n-lg">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label user">Username</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="username" Placeholder="Enter Your Email" class="form-control" id="yourUsername">
                        <div class="invalid-feedback">Please enter your username.</div>
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label user">Password</label>
                      <input type="password" name="password" Placeholder="Enter Password" class="form-control" id="yourPassword">
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-8">
                      <a href="<?php echo base_url();?>/user/forget_password" class="text-primary" type="submit">forgot password</a>
                    </div>
                    <div class="col-12">
                    </div>
                  </form>

...
<table class="table table-bordered table-hover table_variation">
    ...
    <tbody>
        ...
        $variation_name = $this->Common->get_col_by_key('variation','id',$variation_id,'variation_name');
		    ...
		    $del_url = base_url().'master/delete_product_variation/'.$pv->common_key;
		  
		   echo $delete_link = "<a href='javascript:void(0)' onclick='return delete_variation(this.id);' id='$del_url'><i class='fa fa-trash'></i></a>";
          echo" ";

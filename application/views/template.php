...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>webassets/css/magnific-popup.css" type="text/css">
	<link rel="stylesheet" href="<?php echo base_url();?>webassets/css/bootstrap.min.css" type="text/css">
	<style type="text/css">
	body {
	  padding-top: 50px;
	}
...
<script src="<?php echo base_url();?>webassets/js/jquery-3.3.1.min.js"></script>
